...
return [
    'app_api_endpointcalculateprice_calculatepricewithacoupon' => [['product', 'taxNumber', 'couponCode'], ['_controller' => 'App\\Controller\\Api\\EndpointCalculatePriceController::CalculatePriceWithACoupon'], [], [['variable', '/', '[^/]++', 'couponCode', true], ['text', '/couponCode'], ['variable', '/', '[^/]++', 'taxNumber', true], ['text', '/taxNumber'], ['variable', '/', '[^/]++', 'product', true], ['text', '/calculate-price/product']], [], [], []],
    'app_api_endpointcalculateprice_calculatepricewithoutcoupon' => [['product', 'taxNumber'], ['_controller' => 'App\\Controller\\Api\\EndpointCalculatePriceController::CalculatePriceWithoutCoupon'], [], [['variable', '/', '[^/]++', 'taxNumber', true], ['text', '/taxNumber'], ['variable', '/', '[^/]++', 'product', true], ['text', '/calculate-price/product']], [], [], []],
