...
/* base.html.twig */
class __TwigTemplate_76d8c6e41a0da2cfaab366e358e29de7 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 32
        echo "            <div class=\"center_block_main\">
        ...
        echo "</a>
                    ...
                    <nav>
                        <ul>
                            <li><a href=\"";
        // line 22
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("calculate-price");
        echo "\">Calculate</a></li>
                            <li><a href=\"";
        // line 23
    ...
    public function block_h3($context, array $blocks = [])
    {
        ...
        // line 29
        echo "            <br><h3>Click \"Calculate\" if you want to get a price</h3></br>
            <h3>Click \"Purchase\" if you want to buy</h3>
            ";
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ";
        // line 40
        $this->displayBlock('name_product', $context, $blocks);
        // line 41
        echo "\t
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        ";
        // line 46
        $this->displayBlock('price_product', $context, $blocks);
        // line 48
        echo "                                    
                                </tbody>
                            </table> 
                        ...
                        <div class=\"form\">
                            ";
        // line 53
        $this->displayBlock('h2_calculate_price', $context, $blocks);
        // line 55
        echo "                            <fieldset>
                                <legend>";
        // line 56
        ...
        echo "</legend>
                                    <table>
                                        <tr>
                                            ";
        // line 59
        $this->displayBlock('form_calculate_price', $context, $blocks);
        // line 61
        echo "                                        </tr>
                                    </table> 
                           <fieldset>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ";
        // line 69
        $this->displayBlock('table_calculate_price', $context, $blocks);
        // line 70
        echo "\t
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        ";
        // line 75
        $this->displayBlock('tbody_calculate_price', $context, $blocks);
        // line 77
        echo "                                    
                                </tbody>
                            </table>    
                        ...
                        <div class=\"form\">
                            <fieldset>
                                <legend>";
        // line 83
        $this->displayBlock('legend_response', $context, $blocks);
        echo "</legend>
                                    <table>
                                        <tr>
                                            ";
        // line 86
        $this->displayBlock('json_response', $context, $blocks);
        // line 88
        echo "                                        </tr>
                                    </table> 
                           <fieldset>
    ...
    {
        return array (  540 => 87,  530 => 86,  512 => 83,  502 => 76,  492 => 75,  482 => 70,  472 => 69,  462 => 60,  452 => 59,  434 => 56,  424 => 54,  414 => 53,  404 => 47,  394 => 46,  384 => 41,  374 => 40,  360 => 88,  358 => 86,  352 => 83,  344 => 77,  342 => 75,  335 => 70,  333 => 69,  323 => 61,  321 => 59,  315 => 56,  312 => 55,  310 => 53,  303 => 48,  301 => 46,  294 => 41,  292 => 40,  286 => 36,  276 => 35,  264 => 29,  254 => 28,  235 => 18,  221 => 23,  217 => 22,  210 => 18,  207 => 17,  197 => 16,  185 => 93,  183 => 35,  178 => 32,  176 => 28,  173 => 27,  171 => 16,  168 => 15,  158 => 14,  148 => 11,  138 => 10,  128 => 8,  118 => 7,  99 => 5,  87 => 96,  85 => 14,  81 => 12,  79 => 10,  76 => 9,  74 => 7,  70 => 6,  66 => 5,  60 => 1,);
    }
...
<htmllang=\"ru\">
    <head>
        <meta charset=\"UTF-8\">
        <title>{% block title %}Shopping{% endblock title %}</title>
            ...
            <header>
                {% block header %}
                    <div class=\"header_logo\">
                        <a>{% block logo %}Shopping{% endblock logo %}</a>
                    </div>
                    <nav>
                        <ul>
                            <li><a href=\"{{ path('calculate-price')}}\">Calculate</a></li>
                            <li><a href=\"{{ path('purchase')}}\">Purchase</a></li>
                        </ul>
                    </nav>
                {% endblock %}
            </header>
            {% block h3 %}
            <br><h3>Click \"Calculate\" if you want to get a price</h3></br>
            <h3>Click \"Purchase\" if you want to buy</h3>
            {% endblock h3 %}
            <div class=\"center_block_main\">
                ...
                <main>
                    {% block main %}
                        ...
                        <div class=\"form\">
                            <fieldset>
                                <legend>{% block legend_response %}{% endblock legend_response %}</legend>
                                    <table>
                                        <tr>
                                            {% block json_response %}
