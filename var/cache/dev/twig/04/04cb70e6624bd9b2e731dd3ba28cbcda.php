...
class __TwigTemplate_74f85f166cbdd3596f8a6c6712351b3d extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_runs(runs, mode) -%}
    ...
    {%- endif -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/panel.html.twig", "/var/www/vendor/jms/serializer-bundle/Resources/views/Collector/panel.html.twig");
    }
}
